...
import 'moviesSuggestionsVertical.dart';
import 'movies_Suggestions.dart';
                        ...
                        children: [
                          ...
                          Positioned(
                            ...
                            child: Column(
                              children: [
                                Image.asset(
                                    "assets/images/screenpic/watch.png"),
                                SizedBox(
                                    height:
                                        150), // Space between image and text
                                GestureDetector(
                                  onTap: () {
                                    print('Icon tapped');
                                  },
                                        ...
                                        child: ElevatedButton(
                                          ...
                                          style: ElevatedButton.styleFrom(
                                            ...
                                            padding: EdgeInsets.symmetric(
                                                vertical: 15),
                                            // Add vertical padding for more space
                                            ...
                                            children: [
                                              Container(
                                                ...
                                                decoration: BoxDecoration(
                                                  ...
                                                  borderRadius:
                                                      BorderRadius.circular(
                                                          20), // تحديد نصف قطر الزوايا المدورة
                                                ),
                                                child: Padding(
                                      ...
                                      child: Column(
                                        children: [
                                          Container(
                                            ...
                                            decoration: BoxDecoration(
                                              image: DecorationImage(
                                                image: NetworkImage(movieDetails!
                                ...
                                Container(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(height: 20,),
                                      MoviesSuggestionsVertical(movieId: widget.movieId),
                                      SizedBox(height: 10,),
                                      Column(
                                        crossAxisAlignment: CrossAxisAlignment.start,
                                        mainAxisAlignment: MainAxisAlignment.start,
                                        children: [
                                          ...
                                          Container(
                                            child: Text(
                                              movieDetails?.descriptionFull ?? "No summary available",
                                              style: const TextStyle(
                                                fontSize: 19,
